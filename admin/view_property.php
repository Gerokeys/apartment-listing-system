...
<section class="view-property">
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         <p><i></i>ksh <span><?= $fetch_property['price']; ?></span></p>
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i>deposit amount : </i><span><span style="margin-right: .5rem;">Ksh</span><?= $fetch_property['deposit']; ?></span></p>
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i class="fas fa-<?php if($fetch_property['play_area'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>play ground</span></p>
