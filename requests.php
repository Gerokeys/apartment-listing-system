...
<section class="requests">
   ...
   <?php
      ...
      if($select_requests->rowCount() > 0){
        ...
        $select_properties->execute([$fetch_request['property_id']]);
   ...
   <div class="box">
      ...
      <p>enquiry for : <a href="view_property.php?get_id=<?= $fetch_property
      ['id']; ?>"><?= $fetch_property['property_name']; ?></a></p>
